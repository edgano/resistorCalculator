...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tolerance = (Spinner)findViewById(R.id.spinner4);
...
//http://pichelman.com/content/2014/02/25/android-custom-color-spinner/
        ArrayList<ColorSpinnerAdapterItem> color_band = new ArrayList<ColorSpinnerAdapterItem>();
        ...
        color_multi.add(new ColorSpinnerAdapterItem(Color.YELLOW, ""));
